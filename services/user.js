...
export const getFavs = async () => {
  return await axiosInstance.get('product-favorites')
}
// /**
//  * 新增商品id在該會員的我的最愛清單中的
//  */
export const addFav = async (pid) => {
  return await axiosInstance.put(`product-favorites/${pid}`)
}
/**
 * 移除商品id在該會員的我的最愛清單中的
 */
export const removeFav = async (pid) => {
  return await axiosInstance.delete(`product-favorites/${pid}`)
}

// 課程
/**
 * 獲得會員有加在我的最愛的課程id，回傳為id陣列
 */
export const getCourseFavs = async () => {
  return await axiosInstance.get('course-like')
}
/**
 * 新增課程id在該會員的我的最愛清單中的
 */
export const addCourseFav = async (cid) => {
  return await axiosInstance.put(`course-like/${cid}`)
}
/**
 * 移除課程id在該會員的我的最愛清單中的
 */
export const removeCourseFav = async (cid) => {
